...
import (
	...
	rpc "github.com/jackal-dao/canine/emrpc"

	emconfig "github.com/jackal-dao/canine/emserver/config"
)

// StartJSONRPC starts the JSON-RPC server
func StartJSONRPC(ctx *server.Context, clientCtx client.Context, tmRPCAddr, tmEndpoint string, config emconfig.Config) (*http.Server, chan struct{}, error) {
