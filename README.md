...
[![CircleCI](https://circleci.com/gh/jackal-dao/canine/tree/master.svg?style=shield)](https://circleci.com/gh/jackal-dao/canine/tree/master)
[![codecov](https://codecov.io/gh/jackal-dao/canine/branch/master/graph/badge.svg)](https://codecov.io/gh/jackal-dao/canine)
[![Go Report Card](https://goreportcard.com/badge/github.com/jackal-dao/canine)](https://goreportcard.com/report/github.com/jackal-dao/canine)
[![license](https://img.shields.io/github/license/jackal-dao/canine.svg)](https://github.com/jackal-dao/canine/blob/master/LICENSE)
[![LoC](https://tokei.rs/b1/github/jackal-dao/canine)](https://github.com/jackal-dao/canine)
<!-- [![GolangCI](https://golangci.com/badges/github.com/jackal-dao/canine.svg)](https://golangci.com/r/github.com/jackal-dao/canine) -->
...
make test
```
if you are using a linux without X or headless linux, look at [this article](https://ahelpme.com/linux/dbusexception-could-not-get-owner-of-name-org-freedesktop-secrets-no-such-name) or [#31](https://github.com/jackal-dao/canine/issues/31#issuecomment-577058321).
...
Build: `docker build -t jackal-dao/canine:latest .`  or pull from dockerhub
...
docker run --rm -it \
    ...
    jackal-dao/canine:latest /opt/setup_wasmd.sh cosmos1pkptre7fdkl6gfrzlesjjvhxhlc3r4gmmk8rs6

# This will start both wasmd and rest-server, both are logged
docker run --rm -it -p 26657:26657 -p 26656:26656 -p 1317:1317 \
    --mount type=volume,source=wasmd_data,target=/root \
    jackal-dao/canine:latest /opt/run_wasmd.sh
```
...
docker run --rm -it -p 26657:26657 -p 26656:26656 -p 9090:9090 \
    ...
    --mount type=volume,source=wasmd_data,target=/root \
    jackal-dao/canine:latest /opt/run_wasmd.sh /template
...
* `-X github.com/jackal-dao/canine/app.NodeDir=.corald` - set the config/data directory for the node (default `~/.wasmd`)
* `-X github.com/jackal-dao/canine/app.Bech32Prefix=coral` - set the bech32 prefix for all accounts (default `wasm`)
* `-X github.com/jackal-dao/canine/app.ProposalsEnabled=true` - enable all x/wasm governance proposals (default `false`)
* `-X github.com/jackal-dao/canine/app.EnableSpecificProposals=MigrateContract,UpdateAdmin,ClearAdmin` - 
