...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     */
    queryCode: (code_id: string, params?: RequestParams) => Promise<HttpResponse<V1QueryCodeResponse, RpcStatus>>;
    /**
     * No description
     *
     * @tags Query
     ...
     */
    queryContractsByCode: (code_id: string, query?: {
        "pagination.key"?: string;
        "pagination.offset"?: string;
        "pagination.limit"?: string;
        "pagination.count_total"?: boolean;
     ...
     */
    queryRawContractState: (address: string, query_data: string, params?: RequestParams) => Promise<HttpResponse<V1QueryRawContractStateResponse, RpcStatus>>;
    /**
     * No description
     *
     * @tags Query
     ...
     */
    querySmartContractState: (address: string, query_data: string, params?: RequestParams) => Promise<HttpResponse<V1QuerySmartContractStateResponse, RpcStatus>>;
    /**
     * No description
     *
     * @tags Query
