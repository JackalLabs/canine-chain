...
export class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryCode = (code_id, params = {}) => this.request({
         ...
         */
        this.queryContractsByCode = (code_id, query, params = {}) => this.request({
         ...
         */
        this.queryRawContractState = (address, query_data, params = {}) => this.request({
         ...
         */
        this.querySmartContractState = (address, query_data, params = {}) => this.request({
