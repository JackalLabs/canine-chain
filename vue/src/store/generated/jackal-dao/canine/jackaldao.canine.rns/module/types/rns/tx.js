...
const baseMsgRegister = { creator: "", name: "", years: "", data: "" };
...
const baseMsgBid = { creator: "", name: "", bid: "" };
export const MsgBid = {
    encode(message, writer = Writer.create()) {
        if (message.creator !== "") {
            writer.uint32(10).string(message.creator);
...
export const MsgBidResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMsgBidResponse };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                default:
...
const baseMsgAcceptBid = { creator: "", name: "", from: "" };
export const MsgAcceptBid = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMsgAcceptBid };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseMsgAcceptBidResponse = {};
export const MsgAcceptBidResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMsgAcceptBidResponse };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                default:
...
const baseMsgCancelBid = { creator: "", name: "" };
export const MsgCancelBid = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMsgCancelBid };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseMsgCancelBidResponse = {};
export const MsgCancelBidResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMsgCancelBidResponse };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                default:
...
const baseMsgList = { creator: "", name: "", price: "" };
...
export const MsgListResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMsgListResponse };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                default:
...
const baseMsgDelist = { creator: "", name: "" };
...
export const MsgDelistResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMsgDelistResponse };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                default:
...
export class MsgClientImpl {
    ...
    Register(request) {
        ...
        const promise = this.rpc.request("jackaldao.canine.rns.Msg", "Register", data);
    ...
    AcceptBid(request) {
        ...
        const promise = this.rpc.request("jackaldao.canine.rns.Msg", "AcceptBid", data);
        return promise.then((data) => MsgAcceptBidResponse.decode(new Reader(data)));
    }
    CancelBid(request) {
        const data = MsgCancelBid.encode(request).finish();
        const promise = this.rpc.request("jackaldao.canine.rns.Msg", "CancelBid", data);
        return promise.then((data) => MsgCancelBidResponse.decode(new Reader(data)));
    }
    List(request) {
    ...
    Delist(request) {
        ...
        const promise = this.rpc.request("jackaldao.canine.rns.Msg", "Delist", data);
