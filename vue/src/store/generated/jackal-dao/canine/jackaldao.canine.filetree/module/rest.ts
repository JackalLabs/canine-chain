...
export interface FiletreeFiles {
  address?: string;
  contents?: string;
  owner?: string;
...
export interface FiletreeQueryDecryptResponse {
  data?: string;
}

export interface FiletreeQueryEncryptResponse {
  encryptionData?: string;
}

export interface FiletreeQueryGetFilesResponse {
  files?: FiletreeFiles;
}

export interface FiletreeQueryGetKeysResponse {
  keys?: string;
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name QueryDecrypt
   * @summary Queries a list of Decrypt items.
   * @request GET:/jackal-dao/canine/filetree/decrypt/{message}
   */
  queryDecrypt = (message: string, params: RequestParams = {}) =>
    this.request<FiletreeQueryDecryptResponse, RpcStatus>({
      path: `/jackal-dao/canine/filetree/decrypt/${message}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @tags Query
   * @name QueryEncrypt
   * @summary Queries a list of Encrypt items.
   * @request GET:/jackal-dao/canine/filetree/encrypt/{address}/{message}
   */
  queryEncrypt = (address: string, message: string, params: RequestParams = {}) =>
    this.request<FiletreeQueryEncryptResponse, RpcStatus>({
      path: `/jackal-dao/canine/filetree/encrypt/${address}/${message}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @tags Query
   * @name QueryFilesAll
   * @summary Queries a list of Files items.
   * @request GET:/jackal-dao/canine/filetree/files
   */
  queryFilesAll = (
    query?: {
    ...
    this.request<FiletreeQueryAllFilesResponse, RpcStatus>({
      path: `/jackal-dao/canine/filetree/files`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @tags Query
   * @name QueryGetKeys
   * @summary Queries a list of GetKeys items.
   * @request GET:/jackal-dao/canine/filetree/get_keys/{hashpath}
   */
   ...
   * @request GET:/jackaldao/canine/filetree/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<FiletreeQueryParamsResponse, RpcStatus>({
      path: `/jackaldao/canine/filetree/params`,
      method: "GET",
      format: "json",
      ...params,
    });
