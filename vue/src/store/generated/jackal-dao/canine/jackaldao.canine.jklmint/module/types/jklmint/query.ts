...
import { Params } from "../jklmint/params";
...
export interface QueryGetInflationRequest {}

export interface QueryGetInflationResponse {
  inflation: string;
}
...
const baseQueryGetInflationRequest: object = {};

export const QueryGetInflationRequest = {
  encode(
    _: QueryGetInflationRequest,
    writer: Writer = Writer.create()
  ): Writer {
    return writer;
  },
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetInflationRequest,
    } as QueryGetInflationRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromJSON(_: any): QueryGetInflationRequest {
    const message = {
      ...baseQueryGetInflationRequest,
    } as QueryGetInflationRequest;
    return message;
  ...
  toJSON(_: QueryGetInflationRequest): unknown {
    const obj: any = {};
    return obj;
  },

  fromPartial(
    _: DeepPartial<QueryGetInflationRequest>
  ): QueryGetInflationRequest {
    const message = {
      ...baseQueryGetInflationRequest,
    } as QueryGetInflationRequest;
...
const baseQueryGetInflationResponse: object = { inflation: "" };

export const QueryGetInflationResponse = {
  encode(
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetInflationResponse,
    } as QueryGetInflationResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): QueryGetInflationResponse {
    const message = {
      ...baseQueryGetInflationResponse,
    } as QueryGetInflationResponse;
    if (object.inflation !== undefined && object.inflation !== null) {
  ...
  toJSON(message: QueryGetInflationResponse): unknown {
    const obj: any = {};
  ...
  fromPartial(
    object: DeepPartial<QueryGetInflationResponse>
  ): QueryGetInflationResponse {
    const message = {
      ...baseQueryGetInflationResponse,
    } as QueryGetInflationResponse;
...
export interface Query {
  ...
  GetInflation(
    request: QueryGetInflationRequest
  ): Promise<QueryGetInflationResponse>;
}
...
export class QueryClientImpl implements Query {
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request(
      "jackaldao.canine.jklmint.Query",
      "Params",
      data
    );
  ...
  GetInflation(
    ...
    const data = QueryGetInflationRequest.encode(request).finish();
    const promise = this.rpc.request(
      "jackaldao.canine.jklmint.Query",
      "GetInflation",
      data
    ...
    return promise.then((data) =>
      QueryGetInflationResponse.decode(new Reader(data))
    );
  }
}
