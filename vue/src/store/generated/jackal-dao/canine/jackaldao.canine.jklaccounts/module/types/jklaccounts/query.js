...
const baseQueryGetAccountsRequest = { address: "" };
...
const baseQueryGetAccountsResponse = {};
...
const baseQueryAllAccountsRequest = {};
...
const baseQueryAllAccountsResponse = {};
export const QueryAllAccountsResponse = {
    ...
    toJSON(message) {
        const obj = {};
        if (message.accounts) {
            obj.accounts = message.accounts.map((e) => e ? Accounts.toJSON(e) : undefined);
        }
        else {
            obj.accounts = [];
        }
...
export class QueryClientImpl {
    ...
    Accounts(request) {
        ...
        const promise = this.rpc.request("jackaldao.canine.jklaccounts.Query", "Accounts", data);
        return promise.then((data) => QueryGetAccountsResponse.decode(new Reader(data)));
    }
    AccountsAll(request) {
        const data = QueryAllAccountsRequest.encode(request).finish();
        const promise = this.rpc.request("jackaldao.canine.jklaccounts.Query", "AccountsAll", data);
        return promise.then((data) => QueryAllAccountsResponse.decode(new Reader(data)));
    }
}
