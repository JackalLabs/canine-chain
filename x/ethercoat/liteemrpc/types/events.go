...
import (
	...
	evtypes "github.com/jackalLabs/canine-chain/x/ethercoat/evtypes"
...
func ParseTxResult(result *abci.ResponseDeliverTx) (*ParsedTxs, error) {
	...
	for _, event := range result.Events {
		switch event.Type {
		case evtypes.EventTypeEthereumTx:
