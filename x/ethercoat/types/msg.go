...
func NewTx(
	...
	gasLimit uint64, gasPrice, gasFeeCap, gasTipCap *big.Int, input []byte, accesses *gethtypes.AccessList,
) *MsgEthereumTx {
...
func (msg *MsgEthereumTx) FromEthereumTx(tx *gethtypes.Transaction) error {
...
func (msg *MsgEthereumTx) Sign(ethSigner gethtypes.Signer, keyringSigner keyring.Signer) error {
	from := msg.GetFrom()
	if from.Empty() {
...
func (msg MsgEthereumTx) AsTransaction() *gethtypes.Transaction {
	txData, err := UnpackTxData(msg.Data)
	if err != nil {
		return nil
	}

	return gethtypes.NewTx(txData.AsEthereumData())
}

// AsMessage creates an Ethereum core.Message from the msg fields
func (msg MsgEthereumTx) AsMessage(signer gethtypes.Signer, baseFee *big.Int) (core.Message, error) {
