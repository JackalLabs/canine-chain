...
var (
	...
	ErrParentFileNotFound = sdkerrors.Register(ModuleName, 1106, "Parent file does not exist")
	ErrCannotWrite        = sdkerrors.Register(ModuleName, 1107, "You are not permitted to write to this file")
)
