...
func NewMsgPostFile(creator string, account string, hashparent string, hashchild string, contents string, viewers string, editors string, trackingNumber string) *MsgPostFile {
	return &MsgPostFile{
		Creator:        creator,
		Account:        account,
