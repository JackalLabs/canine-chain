...
func (m *Notifications) GetCreator() string {
	if m != nil {
		return m.Creator
	}
	return ""
...
var fileDescriptor_3194dcd8aab024a9 = []byte{
	...
	0xe6, 0x65, 0xe6, 0xa5, 0xea, 0xa1, 0xa8, 0x52, 0xaa, 0xe5, 0xe2, 0xf5, 0x43, 0x16, 0x10, 0x12,
	...
	0x90, 0x4c, 0x72, 0x51, 0x6a, 0x62, 0x49, 0x7e, 0x91, 0x04, 0x0b, 0x44, 0x06, 0xca, 0x75, 0xf2,
	...
	0xd2, 0x24, 0xbd, 0xe4, 0xfc, 0x5c, 0x7d, 0x88, 0x1f, 0x74, 0x53, 0x12, 0xf3, 0xf5, 0x21, 0x9e,
	0xd0, 0xaf, 0x40, 0xf5, 0xac, 0x7e, 0x49, 0x65, 0x41, 0x6a, 0x71, 0x12, 0x1b, 0xd8, 0xcf, 0xc6,
	0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x37, 0x72, 0x3f, 0x24, 0x18, 0x01, 0x00, 0x00,
}
...
func (m *Notifications) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Creator) > 0 {
		...
		i = encodeVarintNotifications(dAtA, i, uint64(len(m.Creator)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Address) > 0 {
