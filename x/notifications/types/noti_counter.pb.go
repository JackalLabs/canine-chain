...
type NotiCounter struct {
	...
	PermittedSenders string `protobuf:"bytes,3,opt,name=permittedSenders,proto3" json:"permittedSenders,omitempty"`
}
...
func (m *NotiCounter) GetPermittedSenders() string {
	if m != nil {
...
var fileDescriptor_628dcfd87205dc09 = []byte{
	...
	,
}
...
func (m *NotiCounter) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.PermittedSenders) > 0 {
		i -= len(m.PermittedSenders)
		copy(dAtA[i:], m.PermittedSenders)
		i = encodeVarintNotiCounter(dAtA, i, uint64(len(m.PermittedSenders)))
		i--
		dAtA[i] = 0x1a
	}
	if m.Counter != 0 {
...
func (m *NotiCounter) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PermittedSenders", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PermittedSenders = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
