...
func init() {
	proto.RegisterType((*Names)(nil), "themarstonconnell.telescope.telescope.Names")
}

func init() { proto.RegisterFile("telescope/names.proto", fileDescriptor_7a2cc5a697fc60a7) }
