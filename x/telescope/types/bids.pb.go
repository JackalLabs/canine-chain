...
func init() {
	proto.RegisterType((*Bids)(nil), "themarstonconnell.telescope.telescope.Bids")
}

func init() { proto.RegisterFile("telescope/bids.proto", fileDescriptor_a39787f62b4010b5) }
