...
// TODO:
// OnChanCloseInit implements the IBCModule interface. Do we need this?
...
// The connection to Jackal wasm bindings could be here
func (im IBCModule) OnRecvPacket(
	ctx sdk.Context,
	packet channeltypes.Packet,
	relayer sdk.AccAddress,
) ibcexported.Acknowledgement {
	return im.keeper.HandleOnRecvPacket(ctx, packet, relayer)
}
