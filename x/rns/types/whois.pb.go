...
func init() {
	proto.RegisterType((*Whois)(nil), "themarstonconnell.rns.rns.Whois")
}

func init() { proto.RegisterFile("rns/whois.proto", fileDescriptor_cc39f1702bd88fcc) }
