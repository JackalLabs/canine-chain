...
func (k Keeper) AllForSale(
	c context.Context,
	req *types.QueryAllForSale,
) (*types.QueryAllForSaleResponse, error) {
	if req == nil {
...
func (k Keeper) ForSale(
	c context.Context,
	req *types.QueryForSale,
) (*types.QueryForSaleResponse, error) {
	if req == nil {
		return nil, status.Error(codes.InvalidArgument, "invalid request")
	}
	ctx := sdk.UnwrapSDKContext(c)
