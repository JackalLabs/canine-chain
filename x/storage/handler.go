...
func NewHandler(k keeper.Keeper) sdk.Handler {
	...
	return func(ctx sdk.Context, msg sdk.Msg) (*sdk.Result, error) {
		...
		case *types.MsgClaimStray:
			...
			return sdk.WrapServiceResult(ctx, res, err)
		case *types.MsgClaimStrayV2:
			res, err := msgServer.ClaimStrayV2(sdk.WrapSDKContext(ctx), msg)
			return sdk.WrapServiceResult(ctx, res, err)
		...
		case *types.MsgRemoveClaimer:
			...
			return sdk.WrapServiceResult(ctx, res, err)
		case *types.MsgPostZKProof:
			res, err := msgServer.PostZKProof(sdk.WrapSDKContext(ctx), msg)
			return sdk.WrapServiceResult(ctx, res, err)
		default:
