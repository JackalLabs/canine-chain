...
var (
	...
	ErrCallbackError        = sdkerrors.Register("wasm-hooks", 8, "Send packet with callback error")
	ErrAccError             = sdkerrors.Register("wasm-hooks", 9, "Ack callback error")
	ErrTimeoutCallbackError = sdkerrors.Register("wasm-hooks", 10, "Timeout callback error")
)
