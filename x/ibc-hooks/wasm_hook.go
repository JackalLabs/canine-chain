...
import (
	...
	"github.com/jackalLabs/canine-chain/v3/x/ibc-hooks/keeper"
	"github.com/jackalLabs/canine-chain/v3/x/ibc-hooks/utils"
	...
	"github.com/jackalLabs/canine-chain/v3/x/ibc-hooks/types"
)
...
func (h WasmHooks) OnAcknowledgementPacketOverride(im IBCMiddleware, ctx sdk.Context, packet channeltypes.Packet, acknowledgement []byte, relayer sdk.AccAddress) error {
	...
	contractAddr, err := sdk.AccAddressFromBech32(contract)
	if err != nil {
		return types.ErrAccError // The callback configured is not a bech32. Error out
	}
...
func (h WasmHooks) OnTimeoutPacketOverride(im IBCMiddleware, ctx sdk.Context, packet channeltypes.Packet, relayer sdk.AccAddress) error {
	...
	contractAddr, err := sdk.AccAddressFromBech32(contract)
	if err != nil {
		return types.ErrTimeoutCallbackError // The callback configured is not a bech32. Error out
	}
