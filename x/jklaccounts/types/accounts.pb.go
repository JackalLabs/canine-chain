...
// source: jklaccounts/accounts.proto
...
type Accounts struct {
	...
	ExpireBlock string `protobuf:"bytes,4,opt,name=expireBlock,proto3" json:"expireBlock,omitempty"`
}
...
func (*Accounts) Descriptor() ([]byte, []int) {
	return fileDescriptor_896e46644bbb6cc6, []int{0}
}
...
func (m *Accounts) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
func (m *Accounts) GetAvailable() string {
	if m != nil {
		return m.Available
	}
	return ""
...
func (m *Accounts) GetUsed() string {
	if m != nil {
		return m.Used
	}
	return ""
...
func (m *Accounts) GetExpireBlock() string {
	if m != nil {
...
func init() {
	proto.RegisterType((*Accounts)(nil), "jackaldao.canine.jklaccounts.Accounts")
}

func init() { proto.RegisterFile("jklaccounts/accounts.proto", fileDescriptor_896e46644bbb6cc6) }

var fileDescriptor_896e46644bbb6cc6 = []byte{
	// 212 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Accounts) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ExpireBlock) > 0 {
		i -= len(m.ExpireBlock)
		copy(dAtA[i:], m.ExpireBlock)
		i = encodeVarintAccounts(dAtA, i, uint64(len(m.ExpireBlock)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Used) > 0 {
		i -= len(m.Used)
		copy(dAtA[i:], m.Used)
		i = encodeVarintAccounts(dAtA, i, uint64(len(m.Used)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Available) > 0 {
		...
		i = encodeVarintAccounts(dAtA, i, uint64(len(m.Available)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Address) > 0 {
...
func (m *Accounts) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.ExpireBlock = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
