...
export const Miners = {
  ...
  fromJSON(object: any): Miners {
    ...
    if (
      object.burnedContracts !== undefined &&
      object.burnedContracts !== null
    ) {
      message.burnedContracts = String(object.burnedContracts);
    } else {
      message.burnedContracts = "";
    }
  ...
  toJSON(message: Miners): unknown {
    ...
    message.burnedContracts !== undefined &&
