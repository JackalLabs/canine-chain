...
replace (
	...
	github.com/evmos/ethermint/rpc/backend => ./emrpc/backend
	github.com/evmos/ethermint/rpc/ethereum => ./emrpc/ethereum
	github.com/evmos/ethermint/rpc/namespaces => ./emrpc/namespaces
	// github.com/cosmos/cosmos-sdk v0.45.5 => github.com/TheMarstonConnell/cosmos-sdk v0.45.5-rotating-0.0.1
