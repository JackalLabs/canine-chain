...
func PerformPostFileTree(
	s *filetreekeeper.Keeper,
	ctx sdk.Context,
	...
	if postFileTree.Creator != contractAddr.String() {
		return sdkerrors.Wrap(
			...
			"creator of bindings is not bindings contract address",
		)
	}
